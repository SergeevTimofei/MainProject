...
class Main(tk.Frame):
    ...
    def init_main(self):
        ...
        self.img_add = tk.PhotoImage(file="project\\plus-circle.png")
        ...
        # Кнопка 'change'
        self.img_upd = tk.PhotoImage(file="project\\edit.png")
        ...
        # Кнопка 'search'
        self.img_search = tk.PhotoImage(file="project\\search.png")
        ...
        # Кнопка 'refresh'
        self.img_refresh = tk.PhotoImage(file="project\\refresh-ccw.png")
    ...
    # Дочернее окно для редактирования

    def open_update_child(self):
        Update()

    # Дочернее окно для поиска 
